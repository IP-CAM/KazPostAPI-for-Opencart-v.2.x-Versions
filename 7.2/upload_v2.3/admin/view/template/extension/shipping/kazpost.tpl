                    ...
                    <div id="tabs">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-general">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_api_server; ?>"><?php echo $entry_api_server; ?></span></label>
									<div class="col-sm-10">
								...
								<div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-value"><span data-toggle="tooltip" title="<?php echo $help_declared_value; ?>"><?php echo $entry_declared_value; ?></span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="kazpost_declared_value" value="<?php echo $kazpost_declared_value; ?>" id="input-value" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="tab-pane" id="tab-database">
								<div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-server1-xls"><span data-toggle="tooltip" title="<?php echo $help_data_xls; ?>"><?php echo $entry_server1_xls; ?></span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="kazpost_server1_xls" value="<?php echo $kazpost_server1_xls; ?>"  id="input-server1-xls" class="form-control" />
                                    </div>                               
                                </div>
								<div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-server2-xls"><span data-toggle="tooltip" title="<?php echo $help_data_xls; ?>"><?php echo $entry_server2_xls; ?></span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="kazpost_server2_xls" value="<?php echo $kazpost_server2_xls; ?>"  id="input-server2-xls" class="form-control" />
                                    </div>                               
                                </div>
								<div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-fromto-sheet"><span data-toggle="tooltip" title="<?php echo $help_fromto_sheetname; ?>"><?php echo $entry_fromto_sheetname; ?></span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="kazpost_fromto_sheetname" value="<?php echo $kazpost_fromto_sheetname; ?>"  id="input-fromto-sheet" class="form-control" />
                                    </div>                               
                                </div>
								<div class="form-group required">
                                    <label class="col-sm-2 control-label" for="input-origin1"><span data-toggle="tooltip" title="<?php echo $help_origin; ?>"><?php echo $entry_origin1; ?></span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="kazpost_origin_city-1" value="<?php echo $kazpost_origin_city1; ?>" placeholder="<?php echo $entry_origin1; ?>" id="input-fromto1" class="form-control" />
                                        <input type="hidden" name="kazpost_origin_id1" value="<?php echo $kazpost_origin_id1; ?>" />
                                    </div>
                                </div>
								<div class="form-group required">
                                    <label class="col-sm-2 control-label" for="input-origin2"><span data-toggle="tooltip" title="<?php echo $help_origin; ?>"><?php echo $entry_origin2; ?></span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="kazpost_origin_city-2" value="<?php echo $kazpost_origin_city2; ?>" placeholder="<?php echo $entry_origin2; ?>" id="input-fromto2" class="form-control" />
                            ...
                            <div class="tab-pane" id="tab-kazpost">
								<div class="col-xs-1">
                                    <ul class="nav nav-tabs tabs-left" id="verticalTab">
                                        <li><a href="#tab-server1" data-toggle="tab"><?php echo $text_server1 ?></a></li>
                                        <li><a href="#tab-server2" data-toggle="tab"><?php echo $text_server2 ?></a></li>
                                    </ul>
                                </div>
								<div class="col-xs-11">
                                    <div class="tab-content">
                                        <div class="tab-pane" id="tab-server1">
											<div class="container-fluid">
												<div class="pull-right">
													<button type="button" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary" onclick="addrow('server1')"><i class="fa fa-plus"></i></button>
												</div>
															...
															<?php if ($kazpost_methods) { ?>
																<?php foreach ($kazpost_methods as $deliverymethod) { ?>
																	<tr>
																		...
																		<td class="text-left"><input type="text" name="kazpost_methods-server1[<?php echo $deliverymethod['id']; ?>][name]" value="<?php echo $deliverymethod['name']; ?>" placeholder="<?php echo $help_data_input; ?>" id="server1-name" class="form-control" />
																			<input type="hidden" name="kazpost_methods-server1[<?php echo $deliverymethod['id']; ?>][id]" value="<?php echo $deliverymethod['id']; ?>" /></td>
																		<td class="text-left"><input type="text" name="kazpost_methods-server1[<?php echo $deliverymethod['id']; ?>][product]" value="<?php echo $deliverymethod['product']; ?>" placeholder="<?php echo $help_data_select; ?>" id="server1-Product" class="form-control" />
																			<input type="hidden" name="kazpost_methods-server1[<?php echo $deliverymethod['id']; ?>][product_id]" value="<?php echo $deliverymethod['product_id']; ?>" /></td>
																		<td class="text-left"><input type="text" name="kazpost_methods-server1[<?php echo $deliverymethod['id']; ?>][sendmethod]" value="<?php echo $deliverymethod['sendmethod']; ?>" placeholder="<?php echo $help_data_select; ?>" id="server1-SendMethod" class="form-control" />
																			<input type="hidden" name="kazpost_methods-server1[<?php echo $deliverymethod['id']; ?>][sendmethod_id]" value="<?php echo $deliverymethod['sendmethod_id']; ?>" /></td>
																		<td class="text-left"><input type="text" name="kazpost_methods-server1[<?php echo $deliverymethod['id']; ?>][mailcat]" value="<?php echo $deliverymethod['mailcat']; ?>" placeholder="<?php echo $help_data_select; ?>" id="server1-MailCat" class="form-control" />
																			<input type="hidden" name="kazpost_methods-server1[<?php echo $deliverymethod['id']; ?>][mailcat_id]" value="<?php echo $deliverymethod['mailcat_id']; ?>" /></td>
																		<td class="text-left"><input type="text" name="kazpost_methods-server1[<?php echo $deliverymethod['id']; ?>][specmarks]" value="<?php echo $deliverymethod['specmarks']; ?>" placeholder="<?php echo $help_data_select; ?>" id="server1-SpecMarks" class="form-control" />
																			<input type="hidden" name="kazpost_methods-server1[<?php echo $deliverymethod['id']; ?>][specmarks_id]" value="<?php echo $deliverymethod['specmarks_id']; ?>" /></td>
																		<td class="text-left"><input type="text" name="kazpost_methods-server1[<?php echo $deliverymethod['id']; ?>][sort_order]" value="<?php echo $deliverymethod['sort_order']; ?>" placeholder="<?php echo $help_data_input; ?>" id="server1-sort_order" class="form-control" /></td>
										...
										<div class="tab-pane" id="tab-server2">
											<div class="container-fluid">
												<div class="pull-right">
													<button type="button" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary" onclick="addrow('server2')"><i class="fa fa-plus"></i></button>
												</div>
												<h3 class="panel-title"><i class="fa fa-list"></i> <?php echo $kazpost_title; ?></h3>
											</div>
											<div class="panel-body">
													...
													<table class="table table-bordered table-hover" id="tab-method-server2">
														<thead>
															<tr>
																...
																<td class="text-right"><?php echo $column_sendmethod; ?></td>
																<td class="text-right"><?php echo $column_mailcat; ?></td>
																<td class="text-right"><?php echo $column_sndrctg; ?></td>
																<td class="text-right"><?php echo $column_sort_order; ?></td>
																<td class="text-right"><?php echo $column_action; ?></td>
															</tr>
														</thead>
														<tbody>
															<?php if ($kazpost_methods2) { ?>
																<?php foreach ($kazpost_methods2 as $deliverymethod2) { ?>
																	<tr>
																		<td class="text-center"><?php echo $deliverymethod2['id']; ?></td>
																		<td class="text-left"><input type="text" name="kazpost_methods-server2[<?php echo $deliverymethod2['id']; ?>][name]" value="<?php echo $deliverymethod2['name']; ?>" placeholder="<?php echo $help_data_input; ?>" id="server2-name" class="form-control" />
																			<input type="hidden" name="kazpost_methods-server2[<?php echo $deliverymethod2['id']; ?>][id]" value="<?php echo $deliverymethod2['id']; ?>" /></td>
																		<td class="text-left"><input type="text" name="kazpost_methods-server2[<?php echo $deliverymethod2['id']; ?>][product]" value="<?php echo $deliverymethod2['product']; ?>" placeholder="<?php echo $help_data_select; ?>" id="server2-Product" class="form-control" />
																			<input type="hidden" name="kazpost_methods-server2[<?php echo $deliverymethod2['id']; ?>][product_id]" value="<?php echo $deliverymethod2['product_id']; ?>" /></td>
																		<td class="text-left"><input type="text" name="kazpost_methods-server2[<?php echo $deliverymethod2['id']; ?>][sendmethod]" value="<?php echo $deliverymethod2['sendmethod']; ?>" placeholder="<?php echo $help_data_select; ?>" id="server2-SendMethod" class="form-control" />
																			<input type="hidden" name="kazpost_methods-server2[<?php echo $deliverymethod2['id']; ?>][sendmethod_id]" value="<?php echo $deliverymethod2['sendmethod_id']; ?>" /></td>
																		<td class="text-left"><input type="text" name="kazpost_methods-server2[<?php echo $deliverymethod2['id']; ?>][mailcat]" value="<?php echo $deliverymethod2['mailcat']; ?>" placeholder="<?php echo $help_data_select; ?>" id="server2-MailCat" class="form-control" />
																			<input type="hidden" name="kazpost_methods-server2[<?php echo $deliverymethod2['id']; ?>][mailcat_id]" value="<?php echo $deliverymethod2['mailcat_id']; ?>" /></td>
																		<td class="text-left"><input type="text" name="kazpost_methods-server2[<?php echo $deliverymethod2['id']; ?>][sndrctg]" value="<?php echo $deliverymethod2['sndrctg']; ?>" placeholder="<?php echo $help_data_select; ?>" id="server2-SndrCtg" class="form-control" />
																			<input type="hidden" name="kazpost_methods-server2[<?php echo $deliverymethod2['id']; ?>][sndrctg_id]" value="<?php echo $deliverymethod2['sndrctg_id']; ?>" /></td>
																		<td class="text-left"><input type="text" name="kazpost_methods-server2[<?php echo $deliverymethod2['id']; ?>][sort_order]" value="<?php echo $deliverymethod2['sort_order']; ?>" placeholder="<?php echo $help_data_input; ?>" id="server2-sort_order" class="form-control" /></td>
																		<td class="text-right"><button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" ><i class="fa fa-trash-o"></i></button></td>
																	</tr>
																<?php } ?>
															<?php } else { ?>
...
// var filename, sheet, row;
    ...
    $('input[name=\'kazpost_origin_city-1\'], input[name=\'kazpost_origin_city-2\'], input[name=\'destination\']').autocomplete({
        source: function (request, response) {
            ...
            $.ajax({
                url: 'index.php?route=extension/shipping/kazpost/autocomplete&token=<?php echo $token; ?>&file=' + filename + '&sheet=' + sheet + '&server=' + server,
                dataType: 'json',
                beforeSend: function () {
                    $("#ajaxloader").show();
                },
	...
	var settings = {
        source: function (request, response) {
           ...
           // }
            ...
            $.ajax({
                url: 'index.php?route=extension/shipping/kazpost/' + processing + '&token=<?php echo $token; ?>&file=' + filename + '&sheet=' + catalog[1] + '&server=' + catalog[0],
                dataType: 'json',
                beforeSend: function () {
                    $("#ajaxloader").show();
                },
